...
class plgContentBespsHelper{
    ...
    */
    ...
    function beSortImages( $myarray, $myorder) { //20090828
    ...
    */
		...
		// replace quotes
    function beKickQuotes($e) { //20090828
    ...
    */
		$mystring=(plgContentBespsHelper::beIs_utf8($mystring))?($mystring):(utf8_encode($mystring));
