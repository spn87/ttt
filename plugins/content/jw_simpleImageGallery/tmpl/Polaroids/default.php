		...
		<span class="sig-link-wrapper">
			<span class="sig-link-innerwrapper">
				<a href="<?php echo $photo->sourceImageFilePath; ?>" class="sig-link" style="width:<?php echo $thb_width; ?>px;height:<?php echo $thb_height; ?>px;" rel="lightbox[gallery<?php echo $galleryID; ?>]" title="<?php echo $photoCaption; ?>" target="_blank">
					<img class="sig-image" src="<?php echo $transparent; ?>" alt="<?php echo JText::_('CLICK_TO_ENLARGE'); ?>" title="<?php echo JText::_('CLICK_TO_ENLARGE'); ?>" style="width:<?php echo $thb_width; ?>px;height:<?php echo $thb_height; ?>px;background-image:url(<?php echo $photo->thumbImageFilePath; ?>);" />
					<?php if($galleryMessages): ?>
					<span class="sig-pseudo-caption"><b><?php echo JText::_('CLICK_TO_ENLARGE'); ?></b></span>
					<span class="sig-caption" title="<?php echo JText::_('CLICK_TO_ENLARGE'); ?>"><?php echo JText::_('CLICK_TO_ENLARGE'); ?></span>
					<?php endif; ?>
				</a>
			</span>
		</span>
