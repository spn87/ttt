    ...
    <div id="djslider<?php echo $mid; ?>" class="djslider">
						...
						<div class="slide-desc">
						  <div class="slide-desc-in">
							...
							<?php if($params->get('show_readmore') && $slide->link) { ?>
								...
								<a href="<?php echo $slide->link; ?>" target="<?php echo $slide->target; ?>" class="readmore"><?php echo JText::_('Readmore'); ?></a>
							<?php } ?>
							<div style="clear: both"></div>
							</div>
						  </div>
		...
		<div id="cust-navigation<?php echo $mid; ?>" class="navigation-container-custom">
			<?php $i = 0; foreach ($slides as $slide) { ?>
				<span class="load-button<?php if ($i == 0) echo ' load-button-active'; ?>"><?php //echo $i+1; ?></span>
