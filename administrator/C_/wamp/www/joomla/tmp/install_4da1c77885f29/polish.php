...
/* RC2.2 */
/* --------------------------------- */
DEFINE("_S_2_GALLERY_NOIMAGES", "Brak galerii");      //Adjust to fit your needs
...
/* RC2.0 */
/* --------------------------------- */
DEFINE('_S_2_GALLERY_TITLE', 'Galeria zdjec');
DEFINE("_SGADM_GEN_POS", "IFrame Position");

/* Beta 4 */
/* --------------------------------- */
DEFINE('_S_2_GALLERY_DELETE_FILE', 'Usun to zdjecie');
DEFINE('_S_2_GALLERY_IMAGE_TITLE', 'Tytul zdjecia ');
DEFINE('_S_2_GALLERY_IMAGES', 'Zdjecia: ');
DEFINE('_S_2_GALLERY_ADD_IMAGE', '<strong>Dodaj zdjecie</strong>');
DEFINE('_S_2_GALLERY_ERR_RESAMPLING', 'Blad obrabiania zdjecia');
DEFINE('_S_2_GALLERY_ERR_COPY', 'Blad kopiowania zdjecia');
DEFINE('_S_2_GALLERY_ERR_MOVE', 'Blad przenoszenia zdjecia');
DEFINE('_S_2_GALLERY_ERR_FILESIZE', 'Zdjecie ma za duzy rozmiar');
DEFINE('_S_2_GALLERY_ERR_EXT', 'Zdjecie jest w nie obslugiwanym formacie.');
