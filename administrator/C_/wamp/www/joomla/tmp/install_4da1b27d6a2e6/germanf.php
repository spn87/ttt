...
DEFINE("_SGADM_GEN_POPUP_EXPL", "Zeigt das Bild in einem Popup-Fenster anstelle der Verwendung des Lightbox Effektes. Dies funktioniert nur im Firefox einwandfrei. Testen Sie es in IE und benutzen Sie es nur wenn Sie mit dem Ergebnis zufrieden sind.");
...
DEFINE('_S_2_ADM_INFO', 'F&uuml;gen Sie "
...
DEFINE('_S_2_ADM_USED_SCRIPT_EXPL', 'Wenn die MooTools Bibliothek durch das Template eingebunden wird, kann es zu Konflikten mit der Lightbox der Galerie kommen. Stellen Sie hier Ja ein um die bestehende MooTools Bibliothek mit der Slimbox anstelle der Lightbox zu benutzen. Haben Sie MooTools nicht installiert, d&uuml;rfen Sie diesen Wert nicht auf Ja stellen. Diese Einstellung it nur g&uuml;ltig wenn der Lightbox-Effekt verwendet wird.');
DEFINE("_SGADM_GEN_POS_EXPL", "IFrame Position im Eingabeformular. Eingabe der Ordnungsnummer. Ein Wert von 0 schaltet den IFrame im Eintragsformular aus.");
...
DEFINE('_S_2_ADM_IFRAME_H_EXPL', 'H&ouml;he des IFrames im Eintragsformular. Angabe entsprechend der max. Gr&ouml;&szlig;e der Vorschaubilder und der max. Anzahl der Bilder. Wenn der Inhalt des IFrames gr&ouml;&szlig;er als die IFrame Gr&ouml;&szlig;e ist, wird ein Rollbalken angezeigt.');
?>